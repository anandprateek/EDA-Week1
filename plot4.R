...
with(reqdata, plot(DateTime, Voltage, type = "l", xlab="datetime", ylab="Voltage"))
...
with(reqdata, plot(DateTime, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
dev.off()